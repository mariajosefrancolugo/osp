...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Visit.reason'
        db.alter_column('visits_visit', 'reason', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Visit.reason'
        db.alter_column('visits_visit', 'reason', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'visits.visit': {
            ...
            'career_services_outcome': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
