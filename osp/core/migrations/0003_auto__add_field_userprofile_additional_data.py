...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.additional_data'
        db.add_column('core_userprofile', 'additional_data', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.additional_data'
        db.delete_column('core_userprofile', 'additional_data')
    ...
    models = {
        ...
        'core.studentindex': {
            'Meta': {'object_name': 'StudentIndex'},
            'email': ('django.db.models.fields.CharField', [], {'max_length': '75'}),
            'first_name': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'full_name': ('django.db.models.fields.CharField', [], {'max_length': '61'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
