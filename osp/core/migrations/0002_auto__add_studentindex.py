...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'StudentIndex'
        db.create_table('core_studentindex', (
            ...
            ('full_name', self.gf('django.db.models.fields.CharField')(max_length=61)),
        ...
        db.send_create_signal('core', ['StudentIndex'])


    def backwards(self, orm):
        
        # Deleting model 'StudentIndex'
        db.delete_table('core_studentindex')
