...
$(".tab-window").append("<hr />");
}
function setTabbed(){
$("#profile_menu-tabs").show();
$(".tab-window").removeClass("tab-window-off").addClass("tab-window-on");
...
$(function(){
    ...
    document.getElementById('tabtoggle').checked = true;
...
function drawRCharts(){
    ...
    if(personality_type_scores[0][0] == 'E'){
        ...
        var r1Rect1 = r1.rect(25, 5, 400*personality_type_scores[0][2], 28, 3);
        var r1Rect2 = r1.rect(25+400*personality_type_scores[0][2], 5, (400 - 400*personality_type_scores[0][2]), 28, 3);
    }
    ...
    // Check for rounding errors and fixing smaller number
    ...
    if(personality_type_scores[0][0] == 'E'){
        ...
        var r1Text = r1.text(50,25,value2).attr({ "font-size": 20, "font-family": "Arial, Helvetica, sans-serif" });;
        r1Text = r1.text(400,25,value1).attr({ "font-size": 20, "font-family": "Arial, Helvetica, sans-serif" });;
    }


    if(personality_type_scores[1][0] == 'N'){
        ...
        var r2Rect1 = r2.rect(25, 5, 400*personality_type_scores[1][2], 28, 3);
        var r2Rect2 = r2.rect(25+400*personality_type_scores[1][2], 5, (400 - 400*personality_type_scores[1][2]), 28, 3);
    }
    ...
    if(personality_type_scores[1][0] == 'N'){
        ...
        var r2Text = r2.text(50,25,value2).attr({ "font-size": 20, "font-family": "Arial, Helvetica, sans-serif" });;
        r2Text = r2.text(400,25,value1).attr({ "font-size": 20, "font-family": "Arial, Helvetica, sans-serif" });;
    }


    if(personality_type_scores[2][0] == 'F'){
        ...
        var r3Rect1 = r3.rect(25, 5, 400*personality_type_scores[2][2], 28, 3);
        var r3Rect2 = r3.rect(25+400*personality_type_scores[2][2], 5, (400 - 400*personality_type_scores[2][2]), 28, 3);
    }
    ...
    if(personality_type_scores[2][0] == 'F'){
        ...
        var r3Text = r3.text(50,25,value2).attr({ "font-size": 20, "font-family": "Arial, Helvetica, sans-serif" });;
        r3Text = r3.text(400,25,value1).attr({ "font-size": 20, "font-family": "Arial, Helvetica, sans-serif" });;
    }
    ...
    if(personality_type_scores[3][0] == 'J'){
        ...
        var r4Rect1 = r4.rect(25, 5, 400*personality_type_scores[3][2], 28, 3);
        var r4Rect2 = r4.rect(25+400*personality_type_scores[3][2], 5, (400 - 400*personality_type_scores[3][2]), 28, 3);
    }
    ...
    if(personality_type_scores[3][0] == 'J'){
        ...
        var r4Text = r4.text(50,25,value2).attr({ "font-size": 20, "font-family": "Arial, Helvetica, sans-serif" });;
